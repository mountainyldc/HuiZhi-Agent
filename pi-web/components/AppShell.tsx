        ...
        <div ref={topBarRef} style={{ display: "flex", alignItems: "center", flexShrink: 0, borderBottom: "1px solid var(--border)", height: 36, background: "var(--bg-panel)" }}>
          ...
          <div
            style={{
              ...
              padding: "0 10px", borderRight: "1px solid var(--border)", flexShrink: 0,
            }}
          >
            <span
              style={{
                background: "#C8102E", color: "#fff", fontWeight: 800, fontSize: 11,
                letterSpacing: 1, borderRadius: 4, padding: "2px 6px", lineHeight: 1.4,
